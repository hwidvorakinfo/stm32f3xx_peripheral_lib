...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccInit(LSM303DLHCAcc_InitTypeDef *LSM303DLHC_InitStruct)
{  
  ...
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG1_A, &ctrl1);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  
  /* Write value to ACC MEMS CTRL_REG4 regsister */
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG4_A, &ctrl4);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccRebootCmd(void)
{
  uint8_t tmpreg;
  uint16_t retval;
  
  /* Read CTRL_REG5 register */
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG5_A, &tmpreg, 1);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  ...
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG5_A, &tmpreg);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccFilterConfig(LSM303DLHCAcc_FilterConfigTypeDef *LSM303DLHC_FilterStruct)
{
  uint8_t tmpreg;
  uint16_t retval;
  
  /* Read CTRL_REG2 register */
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG2_A, &tmpreg, 1);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  ...
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG2_A, &tmpreg);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccFilterCmd(uint8_t HighPassFilterState)
 {
  uint8_t tmpreg;
  uint16_t retval;
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccFilterClickCmd(uint8_t HighPassFilterClickState)
 {
  uint8_t tmpreg;
  uint16_t retval;
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccIT1Config(uint8_t LSM303DLHC_IT, FunctionalState NewState)
{
  uint8_t tmpval = 0x00;
  uint16_t retval;
  
  /* Read CTRL_REG3 register */
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG3_A, &tmpval, 1 );
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  ...
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG3_A, &tmpval);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccIT2Config(uint8_t LSM303DLHC_IT, FunctionalState NewState)
{
  uint8_t tmpval = 0x00;
  uint16_t retval;
  
  /* Read CTRL_REG3 register */
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG6_A, &tmpval, 1);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  ...
  /* Write value to MEMS CTRL_REG3 register */
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG6_A, &tmpval);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccINT1InterruptConfig(uint8_t ITCombination, uint8_t ITAxes, FunctionalState NewState )
{  
  uint8_t tmpval = ITCombination;
  uint16_t retval;
  
  /* Read INT1_CFR register */
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_INT1_CFG_A, &tmpval, 1);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  ...
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_INT1_CFG_A, &tmpval);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccINT2InterruptConfig(uint8_t ITCombination, uint8_t ITAxes, FunctionalState NewState )
{  
  uint8_t tmpval = ITCombination;
  uint16_t retval;
  
  /* Read INT2_CFR register */
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_INT2_CFG_A, &tmpval, 1);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  ...
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_INT2_CFG_A, &tmpval);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_AccClickITConfig(uint8_t ITClick, FunctionalState NewState)
{  
  uint8_t tmpval;
  uint16_t retval;
  
  /* Read CLICK_CFR register */
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_CLICK_CFG_A, &tmpval, 1);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  ...
  retval = LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CLICK_CFG_A, &tmpval);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
uint8_t LSM303DLHC_AccGetDataStatus(void)
{
  ...
  retval = LSM303DLHC_Read(ACC_I2C_ADDRESS, LSM303DLHC_STATUS_REG_A, &tmpreg, 1);
...
/**
  ...
  * @retval Error code
  */
uint16_t LSM303DLHC_MagInit(LSM303DLHCMag_InitTypeDef *LSM303DLHC_InitStruct)
{  
  ...
  retval = LSM303DLHC_Write(MAG_I2C_ADDRESS, LSM303DLHC_CRA_REG_M, &cra_regm);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
  
  /* Write value to Mag MEMS CRB_REG regsister */
  retval = LSM303DLHC_Write(MAG_I2C_ADDRESS, LSM303DLHC_CRB_REG_M, &crb_regm);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}

  /* Write value to Mag MEMS MR_REG regsister */
  retval = LSM303DLHC_Write(MAG_I2C_ADDRESS, LSM303DLHC_MR_REG_M, &mr_regm);
  if (retval == LSM303DLHC_FAIL) {return LSM303DLHC_FAIL;}
...
uint8_t LSM303DLHC_MagGetDataStatus(void)
{
  ...
  /* Read Mag STATUS register */
  retval = LSM303DLHC_Read(MAG_I2C_ADDRESS, LSM303DLHC_SR_REG_M, &tmpreg, 1 );
